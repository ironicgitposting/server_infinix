...
VALUES (1, 1, 'auto', 'tesla', true, now(), now(), 'UI-777-SA', null, null, null);

INSERT INTO public."Vehicules"(id, type, libelle, model, "flagService", "createdAt", "updatedAt", immatriculation, state, status, site)     
VALUES (2, 1, 'auto', '208', true, now(), now(), 'AA-123-FF', null, null, null);

INSERT INTO public."Vehicules"(id, type, libelle, model, "flagService", "createdAt", "updatedAt", immatriculation, state, status, site)     
VALUES (3, 1, 'auto', 'A3', true, now(), now(), 'CV-458-RT', null, null, null);
